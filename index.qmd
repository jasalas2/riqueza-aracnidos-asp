...
-   Registros de presencia de arácnidos: [Consulta al sistema mundial de información de biodiversidad (GBIF)](https://doi.org/10.15468/dl.ghbhx9)
...
```{r}
#| label: filtro_centruroides_limbatus
